...
conversion_factor = 8.8                                              # frequency of laser in Hz
     # Conversion factor used for expermintal noise analysis in V
frequency_laser = speed_of_light/wavelength                   
modulation_frequency= 7*10**6                                       # Moudulation Frequency of the laser in Hz


MaxTimesteps = 5000                                                  # Maximal timesteps for Learning
