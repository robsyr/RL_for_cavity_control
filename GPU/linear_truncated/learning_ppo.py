    ...
    for length in history_length:
        for level in noise_level:
            for size in action_size:
                ...
                models_dir = f"models/{algorithms}_length_{length}_level_{level}_action_size_{size}_try_{i}/"
                logdir = f"logs/{algorithms}_length_{length}_level_{level}_action_size_{size}_try_{i}/"
